...
> Last Index Run: 2026-09-25T18:35:35.952Z
...
Total workspace files tracked: **69** | Total LOC: **10090**
...
| [`package.json`](file:///D:/Users/bfezu/Coding Projects/Shelf_Life/package.json) | 41 | Package Manifest | — | — |
...
| [`src/App.jsx`](file:///D:/Users/bfezu/Coding Projects/Shelf_Life/src/App.jsx) | 194 | Root Application Shell | `App()`, `loadPalette()`, `initApp()` | — |
...
| [`src/components/current/CurrentBookHero.jsx`](file:///D:/Users/bfezu/Coding Projects/Shelf_Life/src/components/current/CurrentBookHero.jsx) | 329 | Dumb UI Presentation | `CurrentBookHero()`, `handleSavePage()` | — |
| [`src/components/current/PaceStatsCard.jsx`](file:///D:/Users/bfezu/Coding Projects/Shelf_Life/src/components/current/PaceStatsCard.jsx) | 184 | Dumb UI Presentation | `PaceStatsCard()` | — |
...
| [`src/components/layout/Header.jsx`](file:///D:/Users/bfezu/Coding Projects/Shelf_Life/src/components/layout/Header.jsx) | 106 | Dumb UI Presentation | `Header()` | — |
...
| [`src/components/library/AddBookModal.jsx`](file:///D:/Users/bfezu/Coding Projects/Shelf_Life/src/components/library/AddBookModal.jsx) | 564 | Dumb UI Presentation | `AddBookModal()`, `handleSearch()`, `handleSelectBook()`, `handleStartManual()` | Open Library REST API |
...
| [`src/components/library/BookDetailModal.jsx`](file:///D:/Users/bfezu/Coding Projects/Shelf_Life/src/components/library/BookDetailModal.jsx) | 375 | Dumb UI Presentation | `BookDetailModal()`, `handleSave()`, `handleSetFocus()`, `handleDelete()` | — |
| [`src/components/library/BookList.jsx`](file:///D:/Users/bfezu/Coding Projects/Shelf_Life/src/components/library/BookList.jsx) | 192 | Dumb UI Presentation | `BookList()` | — |
...
| [`src/components/modals/SpeedOverrideModal.jsx`](file:///D:/Users/bfezu/Coding Projects/Shelf_Life/src/components/modals/SpeedOverrideModal.jsx) | 117 | Dumb UI Presentation | `SpeedOverrideModal()`, `handleSave()` | — |
...
| [`src/services/analyticsEngine.js`](file:///D:/Users/bfezu/Coding Projects/Shelf_Life/src/services/analyticsEngine.js) | 160 | Core Engine / Service | — | — |
| [`src/services/bookService.js`](file:///D:/Users/bfezu/Coding Projects/Shelf_Life/src/services/bookService.js) | 186 | Core Engine / Service | `cleanGenres()` | Open Library REST API |
| [`src/services/colorExtractor.js`](file:///D:/Users/bfezu/Coding Projects/Shelf_Life/src/services/colorExtractor.js) | 260 | Core Engine / Service | `extractPaletteFromImage()`, `rgbToHex()`, `adjustColor()`, `generateHarmoniousPalette()` | — |
...
| [`src/stores/useUIStore.js`](file:///D:/Users/bfezu/Coding Projects/Shelf_Life/src/stores/useUIStore.js) | 40 | Headless Reactive Store | — | — |
...
- [`src/components/library/AddBookModal.jsx`](file:///D:/Users/bfezu/Coding Projects/Shelf_Life/src/components/library/AddBookModal.jsx) (564 lines) — *Must be decomposed into smaller sub-components.*
